...
const FACTION_STYLES = {
  gryffindor: { color: 0xb8974f, priority: 10 },
  slytherin: { color: 0x4f8c74, priority: 10 },
  ravenclaw: { color: 0x6688b5, priority: 10 },
  hufflepuff: { color: 0xc7aa53, priority: 10 },
  order: { color: 0xd19a54, priority: 2 },
  da: { color: 0x9eb9e0, priority: 3 },
  "death-eaters": { color: 0x7f9588, priority: 1 },
  ministry: { color: 0x84a59c, priority: 4 },
  weasleys: { color: 0xc17b4a, priority: 5 },
  malfoys: { color: 0xb9c1b3, priority: 5 },
  "black-family": { color: 0x9b86ae, priority: 5 },
};
...
const FACTION_IDS = new Set(Object.keys(FACTION_STYLES));
